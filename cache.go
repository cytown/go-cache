...
func setValue(o any, v reflect.Value) {
	reflect.ValueOf(o).Elem().Set(v)
}
...
func (c *cache[T]) Increment(k string, n T) error {
	c.mu.Lock()
	defer c.mu.Unlock()
	v, found := c.items[k]
	if !found || v.Expired() {
	...
	if typeOf(n) != typeOf(v.Object) {
		return fmt.Errorf("mismatch type : %v != %v", typeOf(n), typeOf(v.Object))
	}
	...
	case int:
		n1 := any(n).(int)
		n2 := any(v.Object).(int)
		vv = reflect.ValueOf(n1 + n2)
	case int8:
		n1 := any(n).(int8)
		n2 := any(v.Object).(int8)
		vv = reflect.ValueOf(n1 + n2)
	case int16:
		n1 := any(n).(int16)
		n2 := any(v.Object).(int16)
		vv = reflect.ValueOf(n1 + n2)
	case int32:
		n1 := any(n).(int32)
		n2 := any(v.Object).(int32)
		vv = reflect.ValueOf(n1 + n2)
	case int64:
		n1 := any(n).(int64)
		n2 := any(v.Object).(int64)
		vv = reflect.ValueOf(n1 + n2)
	case uint:
		n1 := any(n).(uint)
		n2 := any(v.Object).(uint)
		vv = reflect.ValueOf(n1 + n2)
	case uintptr:
		n1 := any(n).(uintptr)
		n2 := any(v.Object).(uintptr)
		vv = reflect.ValueOf(n1 + n2)
	case uint8:
		n1 := any(n).(uint8)
		n2 := any(v.Object).(uint8)
		vv = reflect.ValueOf(n1 + n2)
	case uint16:
		n1 := any(n).(uint16)
		n2 := any(v.Object).(uint16)
		vv = reflect.ValueOf(n1 + n2)
	case uint32:
		n1 := any(n).(uint32)
		n2 := any(v.Object).(uint32)
		vv = reflect.ValueOf(n1 + n2)
	case uint64:
		n1 := any(n).(uint64)
		n2 := any(v.Object).(uint64)
		vv = reflect.ValueOf(n1 + n2)
	case float32:
		n1 := any(n).(float32)
		n2 := any(v.Object).(float32)
		vv = reflect.ValueOf(n1 + n2)
	case float64:
		n1 := any(n).(float64)
		n2 := any(v.Object).(float64)
		vv = reflect.ValueOf(n1 + n2)
	default:
		return fmt.Errorf("The value for %s[%v] does not have type Number", k, typeOf(n))
	}
	setValue(&v.Object, vv)
	c.items[k] = v
	return nil
}
...
func (c *cache[T]) Decrement(k string, n T) error {
